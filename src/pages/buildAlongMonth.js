...
function BuildAlongMonth() {
  return (
    ...
    <div className={clsx('container', styles.pageContainer, 'max-w-xl', 'mx-auto', 'px-4', 'md:px-6', 'md:py-7', 'lg:px-8', 'lg:py-9', 'lg:max-w-screen-xl', 'pt-4', 'md:pt-6', 'lg:pt-8')}>
    <div className={styles.welcomeBanner}>
        ...
        <div className={styles.questionsSection}>
          ...
          <p> The stories provided below aren't going to give you all the information you need, nor will they walk you through each task step by step like a lab guide typically does. It's up to you to google and do research to achieve the desired results, just like if you were receiving tasks to do at your job. Some of the stories will provide a help link or some extra guidance, but for the most part it's time to practice your Google-Fu! 
            </p>
        </div>

        <div className={styles.needToKnowSection}>
          <h2>What do I need to know?</h2>
          <p>You most likely won't be able to use the stories below right away if you are brand new to the platform. We are making a few assumptions as we write this, and we expect you are familiar with:
          </p>
          <ul style={listStyles}>
          ...
          <li style={listItemStyles}><b>UI Builder</b> - We have a section below that goes in to what UI Builder is and has resources to introduce you to UI Builder. If you have zero experience with UI Builder, we suggest you work through the suggestions first, as they will do a better job of introducing you to UI Builder than this project will. </li>
          <li style={listItemStyles}><b>Technical knowledge</b>  - You have some form of background or have researched about how to work with Agile stories, and you are able to identify what you don't know and are able to google your way to success.
          </li>
          </ul>
        </div>
