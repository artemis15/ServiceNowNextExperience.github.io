            ...
            <div className={clsx('container', styles.pageContainer, 'mx-auto', 'px-4', 'py-4', 'md:px-6', 'md:py-6', 'lg:px-8', 'lg:py-8')}>
                ...
                <CollapsibleSection title="Update set">
                    <div className={styles.uiBuilderSection}>
                        ...
                        <ul style={listStyles}>
                        <li style={listItemStyles}>Download Update Set - <a href="public/downloads/YIBL_BAM_Conference-Notes_v1.0.01.xml" download="YIBL_BAM_Conference-Notes_v1.0.01.xml"><u>📝 BAM Conference Notes v1.0.01 (Last updated 7.28.2024)</u></a></li>
                        <li style={listItemStyles}>Download Update Set - <a href="public/downloads/YYIBL_BAM_Conference-Notes_v1.0.01.zip" download="YIBL_BAM_Conference-Notes_v1.0.01.zip"><u>📝 BAM Conference Notes v1.0.01 (Last updated 7.28.2024)</u></a></li>
                        </ul>
                    </div>
                </CollapsibleSection>
